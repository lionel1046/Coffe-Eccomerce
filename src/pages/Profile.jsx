...
const Profile = () => {
  ...
  const getUserData = async () => {
    try {
      const response = await axios(`https://json-server-production-d0c3.up.railway.app/user/${id}`);
  ...
  const updateProfile = async (e) => {
    ...
    try{
      ...
      const getResponse = await axios(`https://json-server-production-d0c3.up.railway.app/user/${id}`);
      const userObj = getResponse.data;

      // saljemo get(default) request
      const putResponse = await axios.put(`https://json-server-production-d0c3.up.railway.app/user/${id}`, {
        id: id,
